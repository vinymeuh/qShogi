...
int SouthHandModel::rowCount(const QModelIndex& parent) const
{
    Q_UNUSED(parent);
...
QVariant SouthHandModel::data(const QModelIndex& index, int role) const
{
...
void SouthHandModel::onDataChanged()
{
    beginResetModel();
    endResetModel();
}
...
QHash<int, QByteArray> SouthHandModel::roleNames() const
{
